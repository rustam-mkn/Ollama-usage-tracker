...
Меню открывается сразу с последним сохранённым snapshot, а затем может само обновлять usage в фоне каждые 20 минут.
...
Отключить автообновление можно так:

```bash
node ./src/cli.js --refresh-interval 0
```
